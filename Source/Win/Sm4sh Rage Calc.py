...
#create labels
notesLabel = Label(master, text="Welcome to the Smash 4 Rage Calculator! This is a tiny utility that lets you know what percentage is being simulated on your opponent when you hit them while under the effects of rage. For example, if you hit Mario with Pac-Man's F-air while he has 130% damage, and you have 110%, the knockback he receives is the nearly the same as if you hit him at 147% while you had no rage at all. \n \nSince testing effects of rage requires you to be outside of training mode and is therefore super time consuming, this could be helpful for determining whether or not kill confirms or combos are still true at certain percents/amounts of rage. \nAll move data can be found on http://kuroganehammer.com/Smash4.", bg="#242424", fg="#fdb3b3", highlightbackground="#2d2d2d", wraplength=950, justify=CENTER, font=("Calibri", 13)).grid(row=0, columnspan=4, sticky=W, pady=10, padx=15)

charLabel = Label(master, text="Opponent's Character:", bg="#242424", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=1, sticky=W, pady=5, padx=15)
damageLabel = Label(master, text="Opponent's Percentage:", bg="#242424", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=2, sticky=W, pady=5, padx=15)
selfdamageLabel = Label(master, text="Your Percentage:", bg="#242424", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=3, sticky=W, pady=5, padx=15)
attackDamageLabel = Label(master, text="Attack's Damage:", bg="#242424", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=4, sticky=W, pady=5, padx=15)
attackDescLabel = Label(master, text="On KuroganeHammer.com, this is Base Dmg. value.", bg="#242424", fg="#ffe699", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=4, column=3, sticky=W, pady=5, padx=15)
kbGrowthLabel = Label(master, text="Knockback Growth:", bg="#242424", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=5, sticky=W, pady=5, padx=15)
kbGrowthDescLabel = Label(master, text="On KuroganeHammer.com, this is KBG value, divided by 100 (ex. KBG of 90, put 0.9).", bg="#242424", fg="#ffe699", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=5, column=3, sticky=W, pady=5, padx=15)
kbBaseLabel = Label(master, text="Base Knockback:", bg="#242424", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=6, sticky=W, pady=5, padx=15)
kbBaseDescLabel = Label(master, text="On KuroganeHammer.com, this is BKB/WBKB value.", bg="#242424", fg="#ffe699", highlightbackground="#2d2d2d", font=("Calibri", 13)).grid(row=6, column=3, sticky=W, pady=5, padx=15)
resultLabel = Label(master, text="", bg="#363636", fg="#a6d0f0", highlightbackground="#2d2d2d", font=("Calibri", 13))
resultLabel.grid(row=8, sticky=W, padx=15, columnspan=2, pady=5)
copyLabel = Label(master, text="All code by DuckDuckPony, using Python/Tkinter. Formulas for knockback/rage found on www.ssbwiki.com. Follow me on Twitter @DuckDuckBryan. Thanks for checking this out!", bg="#242424", fg="#9fffcc", highlightbackground="#2d2d2d", wraplength=950, justify=CENTER, font=("Calibri", 9)).grid(row=9, columnspan=4, sticky=W, pady=10, padx=15)

#create entries
oDamEnt = Entry(master, highlightbackground="#363636", font=("Calibri", 13))
sDamEnt = Entry(master, highlightbackground="#363636", font=("Calibri", 13))
aDamEnt = Entry(master, highlightbackground="#363636", font=("Calibri", 13))
kbGrowthEnt = Entry(master, highlightbackground="#363636", font=("Calibri", 13))
kbBaseEnt = Entry(master, highlightbackground="#363636", font=("Calibri", 13))
...
# adjust window size
master.minsize(width=1050,height=550)
...
option.configure(highlightbackground="#2d2d2d", font=("Calibri", 13))
...
button = Button(master, text="Calculate Equivalent Percent", command=printKnockback, highlightbackground="#242424", font=("Calibri", 13))
